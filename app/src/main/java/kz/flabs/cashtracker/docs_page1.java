...
public class docs_page1 extends ActionBarActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.docs_page, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_docs_page, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((docs_page1) activity).onSectionAttached(
