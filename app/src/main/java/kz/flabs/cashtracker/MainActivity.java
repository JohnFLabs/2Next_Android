...
public class MainActivity extends ActionBarActivity {
    ...
    public void chooseLang(View view) {
        Intent intent = new Intent(MainActivity.this, choose_lang_page.class);
            ...
            try {
                ...
                if (resEntityGet != null) {
                    ...
                    try {
                       ...
                       // intent.putExtra("response", response_string);ъ
               ...
               // findViewById(R.id.progressBar1).setVisibility(View.GONE);
                ...
                try {
                   ...
                   // JSONArray jsonMainNode = jobject.optJSONArray("elements");
                    ...
                    TextView switch_lang_link = (TextView)findViewById(R.id.current_lang);
                    switch_lang_link.setText(current_lang);
